...
process.env.BTCPAY_MASTER_KEY = process.env.BTCPAY_MASTER_KEY ?? strongBase64(32);
process.env.BTCPAY_API_KEY_PEPPER = process.env.BTCPAY_API_KEY_PEPPER ?? strongBase64(32);
